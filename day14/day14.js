//moviesjson-this is chrome browser
let movies=
[
    {
      "Title": "Avatar",
  ...
  //1.print all the titles
//  movies.map((data)=>{
//  console.log(data.Title);
//  })


  //2.print all the movie titles
// movies.map((data)=>{
//     if(data.Type=="movie"){
//         console.log(data.Title);
//     }
...
//3.print the movies director by james cameron
// let res=movies.filter((data)=>{
//     if(data.Director=="James Cameron"){
//         console.log(data.Title);
//     }
// })
...
// })
 ...
 //4.print the movies released after 2012
//  let res=movies.filter((data)=>{
//     if(data.Year>2012){
//         console.log(data.Title);
//     }
...
//  console.log(res);
 ...
 //5.print the movie which has highest IMDB rating

let values=movies.map((data)=>{
    return data.imdbRating
})
console.log(values);
let imdb=values.filter((data)=>{
    return data !=="N/A"
})
console.log(imdb);
let highest=Math.max(...imdb)//spread operator
console.log(highest);